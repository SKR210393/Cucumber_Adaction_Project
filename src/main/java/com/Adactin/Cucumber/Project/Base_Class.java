package com.Adactin.Cucumber.Project;
...
//	Sleep
	...
	public static void takeSnap(String path) throws Throwable {
...
//	Read Data
	...
	public static String particularData(String path, int row_Index, int cell_Index) throws IOException {
		...
		if (cellType.equals(CellType.STRING)) {
			...
			int val = (int) numericCellValue; // Type casting
...
//	Frames
	...
	public static void defaultFrames() {

		driver.switchTo().defaultContent();
	}

	public static void framesByIndex(int frameIndex) {
